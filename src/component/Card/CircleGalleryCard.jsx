...
class Title {
  ...
  createMesh() {
    ...
    this._scaleX = textWidthScaled;
    this._scaleY = textHeightScaled;
  ...
  setVisible(visible) {
    const s = visible ? 1 : 0;
    this.mesh.scale.set(this._scaleX * s, this._scaleY * s, 1);
  }
}
...
class Media {
    ...
    this.program = new Program(this.gl, {
      ...
      vertex: `
        ...
        void main() {
          vUv = uv;
          vec3 p = position;
          p.z = (sin(p.x * 4.0 + uTime) + cos(p.y * 2.0 + uTime)) * (0.06 + uSpeed * 0.28);
  ...
  update(scroll, direction) {
    ...
    const isCenter =
      Math.abs(this.plane.position.x) < this.viewport.width * 0.38;
  ...
  onResize({ screen, viewport } = {}) {
    ...
    this.padding = Math.max(2, this.plane.scale.x * 0.22);
